...
- Added opt-in public `test-79-npm` smoke coverage for dictionary-driven
  ...
  `logform` formatter loader, `body-parser`, pinned `body-parser@1.10.2`,
  `express` with `jade`, and pinned `log4js@0.5.8` / `log4js@0.6.34` /
  `log4js@1.1.1`, `negotiator`, and pinned `negotiator@0.4.9`, plus
  `machinepack-urls`, pinned
